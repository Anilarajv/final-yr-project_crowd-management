...
def video_process(cap, frame_size, net, ln, encoder, tracker, movement_data_writer, crowd_data_writer):
	...
	while True:
		...
		if len(humans_detected) > 1:
		
				current_date = "Overcrowded"
				cv2.putText(frame, (current_date), (40, 600), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 3)
	
				
		else:
				current_date2 = "Safe"
				cv2.putText(frame, (current_date2), (40, 600), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 3)
		...
		cv2.putText(frame, (current_date), (500, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (3, 3, 3), 6)
		cv2.putText(frame, (current_time), (500, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (3, 3, 3), 6)
